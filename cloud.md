...
- VOLGENDE STAP: `vanilla.waves_elements` als eigen repo/CDN — destilleer de `data-wv`-types uit `docs/examples.js` (begin met `loader`/`eq`), gebouwd op de gepubliceerde engine. Optioneel nog: guide/about/waves-referentiepagina's + eigen naam voor de hallmark-pagina (bv. "Element Foundry").
